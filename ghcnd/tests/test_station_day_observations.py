...
class TestStationDayObservations(unittest.TestCase):
    ...
    def test_parse_observations(self):
        ...
        self.assertEqual(obs[30].temp_max, 332)
        self.assertEqual(obs[30].temp_min, 139)
        self.assertEqual(obs[77].date, date(2022, 10, 17))
        self.assertEqual(obs[77].temp_max, 150)
        self.assertEqual(obs[77].temp_min, 61)
